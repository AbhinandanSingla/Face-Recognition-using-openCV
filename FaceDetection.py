...
while True:
    ...
    try:
        ...
        cv2.putText(img,display_string,(110,120),cv2.FONT_HERSHEY_COMPLEX,1,(250,120,255))

        if confidence > 75:
            cv2.putText(img, 'Unlocked', (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0))
        ...
        cv2.putText(img, 'No Face', (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255))
        cv2.imshow('Face Cropper', img)
        pass
